...
if first_letter == first_letter.upper():
    first_letter in vowel_list == True
    pig_latin = "".join(first_letter +orig_word[1:]+ suf_vowel)
    print(orig_word + " in pig latin is " + pig_latin)
elif first_letter not in vowel_list
    pig_latin = "".join(orig_word[1:].upper() + first_letter.lower() + suf_consonant):
    print(orig_word + " in pig latin is " + pig_latin)
elif first_letter in vowel_list:
    pig_latin = orig_word+suf_vowel
    print(orig_word + " in pig latin is " + pig_latin)
# elif first_letter != vowel_list:
